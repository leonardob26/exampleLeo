...
public class PeopleImpl implements IPeople {
	...
	@Override
	public net.insightglobal.model.People getPeopleVehicle(int idPeople) {
		net.insightglobal.model.People people = new net.insightglobal.model.People();
	...
	@Override
	public net.insightglobal.model.People getPeople(int id) {
		net.insightglobal.model.People people = new net.insightglobal.model.People();
		if (id==0){
			people.setName("");
			return people;
