...
import com.devone.repositories.PeopleRepository;
...
public class PeopleImpl implements IPeople {
	...
	@Override
	public com.devone.model.People getPeopleVehicle(int idPeople) {
		com.devone.model.People people = new com.devone.model.People();
	...
	@Override
	public com.devone.model.People getPeople(int id) {
		com.devone.model.People people = new com.devone.model.People();
		if (id==0){
			people.setName("");
			return people;
