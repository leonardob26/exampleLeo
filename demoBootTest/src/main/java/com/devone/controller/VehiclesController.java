...
import com.devone.model.logger.Errors;

import com.devone.model.Vehicle;
import com.devone.model.VehicleImpl;
@Controller
public class VehiclesController {
	@Autowired
	private VehicleImpl vehicle;
	
	@RequestMapping(path = "/vehiclesList", method = RequestMethod.GET)
